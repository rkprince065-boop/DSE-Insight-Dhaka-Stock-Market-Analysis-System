...
COPY companies
FROM 'H:\DSE Insight Dhaka Stock Market Analysis System\CSV\Companies.csv'
WITH (FORMAT csv, HEADER true, DELIMITER ',', ENCODING 'UTF8');

COPY day_end_archive
FROM 'H:\DSE Insight Dhaka Stock Market Analysis System\CSV\Day End Archive.csv'
WITH (FORMAT csv, HEADER true, DELIMITER ',', ENCODING 'UTF8');
